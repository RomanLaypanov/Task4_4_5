...
public class Deserializer {
    public static Animal[] deserializeAnimalArray(byte[] data) throws ClassNotFoundException, IOException {
        try (ByteArrayInputStream byteArray = new ByteArrayInputStream(data); ObjectInputStream ois = new ObjectInputStream(byteArray)) {
            ...
            return result;
        } catch (ArrayIndexOutOfBoundsException | ClassCastException | EOFException | NegativeArraySizeException |
